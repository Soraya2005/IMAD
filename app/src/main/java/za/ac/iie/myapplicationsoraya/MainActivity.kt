package za.ac.iie.myapplicationsoraya
            ...
            if (input.isEmpty()) {
                ...
                when(input) {
                    "morning" -> {
                        ...
                        backgroundImageToSet = ContextCompat.getDrawable(this, R.drawable.egg)
                    }
                    "mid-morning" -> {
                    ...
                    "after-dinner" -> {
                        ...
                        backgroundImageToSet = ContextCompat.getDrawable(this, R.drawable.ice)
                    }
                    else -> {
                        if(input.length < 3) {
                            errorText.text = "Please enter a more specific time (e.g., Morning, Afternoon)"
                        } else {
