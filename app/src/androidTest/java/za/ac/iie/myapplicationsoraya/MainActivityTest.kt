...
// Set up references to UI elements
            val button: Button = activity.findViewById(R.id.submitButton)
            val textView: TextView = activity.findViewById(R.id.suggestionText)
...
// Check if the TextView's text was updated
            assertEquals("Breakfast: Eggs", textView.text)
